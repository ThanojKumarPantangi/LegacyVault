...
const NomineeLayout = () => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/nominee/dashboard", icon: LayoutDashboard },
    {
      name: "Available Inheritances",
      href: "/nominee/available",
      icon: Gift,
    },
    { name: "Released Assets", href: "/nominee/released", icon: KeyRound },
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row">
      ...
      >
        ...
        <div className="mb-6 p-4 rounded-xl bg-slate-950/40 border border-slate-800">
          ...
          <span className="inline-block bg-indigo-500/10 text-indigo-400 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full border border-indigo-500/20 mt-1.5">
            {user?.role}
          </span>
        </div>
